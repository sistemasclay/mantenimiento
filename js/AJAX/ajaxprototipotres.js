        ...
        if(document.getElementById('Boton').value=="Crear")
		  {
			 ...
			 if(document.getElementById('arbol').checked==true){arb=1;} else{arb=0;}
		       ...
		       capa="modulos/documentos/crearAreaDocumentos.php?nombreArea=" + nombre + "&seleccionado=" + sel + "&seleccionadoAcc=" + selAcc + "&userSelectAdmtemp=" + uSelA + "&userSelectAcctemp=" + uSelAcc + "&publico=" + pub + "&arbol=" + arb + "&Boton=True";
			  ...
			  capa="modulos/documentos/modificarAreaDocumentos.php?nombreArea=" + nombre + "&seleccionado=" + sel + "&seleccionadoAcc=" + selAcc + "&userSelectAdmtemp=" + uSelA + "&userSelectAcctemp=" + uSelAcc + "&nodo=" + nodoenv + "&id_area=" + idarea + "&Boton=1&color=" + colorsel;
			 }

    
cargarcapaAplicacion('capa_Contenido_Aplicacion',capa);
...
capa	=	"modulos/documentos/borrarAreaDocumentos.php?areasSel=" + codarea + "&Boton=True";
...
capa		=	"modulos/directorios/crearAreaContactos.php?nombreArea=" + nombrearea + "&Boton=True";
...
capa		= "modulos/directorios/borrarAreaContactos.php?areasSelectAdm=" + nombrearea + "&Boton=True";
...
capa		=	"modulos/directorios/index.php?tipo=" + nombrearea;
...
capa	=	"modulos/directorios/index.php?search_string=" + buscar + "&m='contacts'&tipo=0";
...
capa = "modulos/directorios/index.php?titulo='" + titulo + "'&tipo='" + tipo + "'&men='" + men + "'&autor='" + autor + "'";
...
if(vabot=="Crear Auditorio")
   {
    ...
    capa="modulos/auditorio/crearAreaDocumentos.php?nombreArea=" + nombre + "&seleccionado=0&seleccionadoAcc=0&Boton=TRUE";
   }
...
if(vabot=="Actualizar")
   {
	...
	var id_area	=document.getElementById('id_area').value;
	 ...
	 capa="modulos/auditorio/modificarAreaDocumentos.php?nombreArea=" + nombre + "&seleccionado=0&seleccionadoAcc=0&id_area=" + id_area + "&Boton=TRUE";
   }
...
if(vabot=="Borrar")
   {
	 ...
	 capa="modulos/auditorio/borrarAreaDocumentos.php?areasSelectAdm=" + area + "&Boton=TRUE";
   }
...
capa = "modulos/helpdesk/formaSoporte.php?areaSelect=" + area + "&userSelect=" + user + "&naturaleza=" + naturaleza + "&textodescripcion=" + texto + "&administrador=" + admin + "&id_area=" + id_area + "&Boton=TRUE";
...
case 1:
     ...
     capa="modulos/helpdesk/requerimientosSoporte.php?id_solucion=" + id_solucion + "&identificador=" + identificador + "&observaciones=" + observaciones + "&email=" + email;
    break;
...
case 2:
	...
	capa="modulos/helpdesk/requerimientosSoporte.php?id_pendiente=" + id_pendiente + "&identificador=" + identificador + "&observaciones=" + observaciones + "&email=" + email;
   break;
    ...
    b=0;
       ...
       for (var intLoop=0; intLoop < document.getElementById('userSelectAdm').length; intLoop++) {
            if (document.getElementById('userSelectAdm').options[intLoop].selected) 
			  ...
			  capa="modulos/noticias/modificarAreaDocumentos.php?nombreArea=" + nombre + "&seleccionado=" + sel + "&seleccionadoAcc=" + selAcc + "&userSelectAdmtemp=" + uSelA + "&userSelectAcc=0" + "&nodo=" + nodoenv + "&id_area=" + idarea + "&Boton=1&color=" + colorsel;
    ...
    b=0;
       ...
       for (var intLoop=0; intLoop < document.getElementById('userSelectAdm').length; intLoop++) {
            if (document.getElementById('userSelectAdm').options[intLoop].selected) 
			  ...
			  capa="modulos/noticias/crearAreaDocumentos.php?nombreArea=" + nombre + "&seleccionado=" + sel + "&seleccionadoAcc=" + selAcc + "&userSelectAdmtemp=" + uSelA + "&userSelectAcc=0" + "&Boton=1";
...
capa="modulos/noticias/borrarAreaDocumentos.php?areasSelectAdm=" + codarea + "&Boton=True";
...
case 1:
   ...
   capa="modulos/noticias/insertarNoticia.php?titulo=" + titulo + "&textodescripcion=" + textodescripcion + "&men=" + men + "&autor=" + autor + "&id_area=" + id_area;
break;
...
case 3:
    ...
    capa="modulos/noticias/editarNoticia.php?titulo=" + titulo + "&textodescripcion=" + textodescripcion + "&men=" + men + "&autor=" + autor +  "&id_area=" + id_area + "&id_noticias=" + id_noticias;
break;
...
case 4:
    ...
    var id_noticias			=	document.getElementById('id_noticias').value;
	capa="modulos/noticias/borrarNoticia.php?id_noticias=" + id_noticias + "&confirmacion=" + confirmacion;
break;
...
case 0:
	   ...
	   capa="modulos/documentos/herramientasEdicion.php?accion=" + accion + "&sig=" + sig + "&rut=" + rut + "&nodeName=" +  nodeName + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tabla=" + tabla + "&tab=" + tab + "&link=" + vinculo + "&textodescripcion=" + textodescripcion + "&funcion=0";
       break;

case 1:
       capa="modulos/documentos/herramientasEdicion.php?accion=" + accion + "&sig=" + sig + "&rut=" + rut + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tabla=" + tabla + "&tab=" + tab + "&link=" + vinculo + "&funcion=1";
       break;

case 2:
       capa="modulos/documentos/herramientasEdicion.php?accion=" + accion + "&sig=" + sig + "&rut=" + rut + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tabla=" + tabla + "&tab=" + tab + "&link=" + vinculo + "&funcion=2";
        break;


case 3:
      capa="modulos/documentos/herramientasEdicion.php?accion=" + accion + "&sig=" + sig + "&rut=" + rut + "&nodeName=" +  nodeName + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tabla=" + tabla + "&tab=" + tab + "&link=" + vinculo + "&funcion=3";
       break;
	  
case 4:
       var enlace = 	document.getElementById('enlace').value;
	
	   capa="modulos/documentos/herramientasEdicion.php?accion=" + accion + "&nodeName=" +  nodeName + "&nodo=" + nodo + "&tab=" + tab + "&enlace=" + enlace + "&funcion=4";
      break;

case 5:
       capa="modulos/documentos/herramientasEdicion.php?accion=" + accion + "&sig=" + sig + "&rut=" + rut + "&nodeName=" +  nodeName + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tabla=" + tabla + "&tab=" + tab + "&link=" + vinculo + "&textodescripcion=" + textodescripcion + "&funcion=5";
       break;
...
cargarcapaAplicacion('capa_herramientaedicion',capa);
...
case "0":
     ...
     capa=accion + "?sig=" + sig + "&rut=" + rut + "&nuevoNombre=" +  nuevoNombre + "&nuevaDescripcion=" + nuevaDescripcion + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tabla=" + tabla + "&tab=" + tab + "&link=" + vinculo + "&funcion=0";
     break;
...
case "1":  
       ...
       capa=accion + "?sig=" + sig + "&rut=" + rut + "&nombre=" +  nombre + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tabla=" + tabla + "&tab=" + tab + "&link=" + vinculo + "&funcion=1";
     break;
...
case "2":
       ...
       capa=accion + "?sig=" + sig + "&rut=" + rut + "&image=" +  image + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tabla=" + tabla + "&tab=" + tab + "&link=" + vinculo + "&descripcion=" + descripcion + "&MAX_FILE_SIZE=20000000&funcion=2";
     break;
...
case "3":
     ...
     capa=accion + "?sig=" + sig + "&rut=" + rut + "&nodeName=" +  nodeName + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tabla=" + tabla + "&tab=" + tab + "&link=" + vinculo + "&funcion=3";
     break;
...
case "4":
     ...
     capa=accion + "?nuevoNombre=" +  nuevoNombre + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tab=" + tab + "&link=" + vinculo + "&enlace=" + enlace +  "&funcion=4";
     break;
...
case "5":
     ...
     capa=accion + "?sig=" + sig + "&rut=" + rut + "&nuevoNombre=" +  nuevoNombre + "&nodeId=" + nodeId + "&nodo=" + nodo + "&tabla=" + tabla + "&tab=" + tab + "&link=" + vinculo + "&nuevaDescripcion=" + nuevaDescripcion + "&funcion=5";
...
var capa,direccionvars;

capa	=	document.getElementById("descripcionevento");
    
	direccionvars="modulos/calendario/evento.php?nombre="+nombre+"&hora="+hora+"&descripcion="+descripcion+"&duracion="+duracion+"&lugar="+lugar+"&fecha="+fecha;
...
switch(funcion)
{
     case 0:
	        ...
	        for (var intLoop=0; intLoop < document.getElementById('asignaciones').length; intLoop++) {
              ...
              cargarcapaAplicacion("capa_Contenido_Aplicacion","modulos/ToDo/ToDogrupos.php?asignaciones="+asignaciones+"&descripciontarea="+descripciontarea+"&prioridad="+prioridad+"&botonToDo=TRUE");
     ...
     case 1:
            ...
            cargarcapaAplicacion("mostrarToDo","modulos/ToDo/index.php?descripciontarea="+descripciontarea+"&prioridad="+prioridad+"&funcion=1");
       break;	

     case 2:
            cargarcapaAplicacion("mostrarToDo","modulos/ToDo/index.php?id="+id+"&funcion=2");
       break;	
...
{
     case 0:
            cargarcapaAplicacion("capa_herramientaedicion","modulos/calendario/insertarEvento.php");
	 break;
}
...
{
     case 0:
            cargarcapaAplicacion("capa_Contenido_Aplicacion","modulos/auditorio/herramientasequipos.php?id="+idelementos+"&funcion=1");
	 break;
	 
	 case 1:
            cargarcapaAplicacion("capa_Contenido_Aplicacion","modulos/auditorio/herramientasequipos.php?id="+idelementos+"&funcion=2");
	 break;
	 
	case 2:
            cargarcapaAplicacion("capa_Contenido_Aplicacion", "modulos/auditorio/herramientasequipos.php?id=0&funcion=3");
	 break;
