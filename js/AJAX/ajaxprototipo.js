...
if(funcion==0)
   {
	ajax.open("POST", "modulos/directorios/herramientas.php?funcion=0&accion=" + accion + "&tab=" + tab + "&contac_owner=" + contac_owner, true);
   }


if(funcion==1)
   {
	ajax.open("POST", "modulos/directorios/herramientas.php?funcion=1&accion=" + accion + "&tab=" + tab + "&arr=" + arr, true);
   }


if(funcion==2)
   {
	ajax.open("POST", "modulos/directorios/herramientas.php?funcion=2&accion=" + accion + "&tab=" + tab + "&textolink=" + textolink + "&arr=" + arr, true);
   }
