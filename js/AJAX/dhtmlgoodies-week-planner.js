...
/*	if(!inputDiv)inputDiv = this;
    ...
    var capa	=	document.getElementById('capa_IngresoActualizacionWP');
	
	ajaxalt=nuevoAjaxAlterno();
	
	ajaxalt.open( "POST", "../edit_event.php", true);
    
	ajaxalt.onreadystatechange=function() 
	    {
		   if (ajaxalt.readyState==4) 
		      {
		        capa.innerHTML=ajaxalt.responseText
	 	      }
	    }
